...
export class SareesComponent {
  readonly sarees: Saree[] = [
    ...
    { id: 7, name: 'Half Saree', price: 999, image: '/half saree 7.png' },
    { id: 8, name: 'Half saree', price: 999, image: '/half saree 8.png' },
    { id: 9, name: 'Half saree', price: 999, image: '/half saree 9.png' },
    { id: 10, name: 'Half saree', price: 999, image: '/half saree 10.png' },
    { id: 11, name: 'Half saree', price: 999, image: '/half saree 11.png' },
    { id: 12, name: 'Half saree', price: 999, image: '/half saree 12.png' }
